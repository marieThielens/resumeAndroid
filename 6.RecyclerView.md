...
public class PersonneAdapter extends RecyclerView.Adapter<PersonneAdapter.ViewHolder> {
    ...
    private List<Personne> personneData; // Pour les data
    ...
    public PersonneAdapter(List<Personne> gens) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.main_personne_item, parent, false);
